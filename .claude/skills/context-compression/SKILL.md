...
- Session has completed 15+ tasks or 10+ file changes (see Session Scoping in `workflow.md`)
- Agent sessions exceed context window limits
- Context feels heavy (many file reads, long conversation)
- User says "wrap up", "stop", "handoff"

**Preferred action**: Write `docs/handoff.md` per the Handoff Protocol in `.claude/rules/workflow.md`, then end session cleanly. This is more reliable than in-context compression.
